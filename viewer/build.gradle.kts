...
dependencies {
    ...
    // implementation(files("/home/stormy/dev/github/rla/rlauxe/core/build/libs/rlauxe-core-0.10.2.0-uber.jar"))
    implementation(files("../libs/rlauxe-core-0.10.2.0-uber.jar"))
