...
dependencies {
    ...
    // implementation(files("/home/stormy/dev/github/rla/rlauxe/cases/build/libs/rlauxe-cases-0.10.4.0-uber.jar"))
    implementation(files("../libs/rlauxe-cases-0.10.4.0-uber.jar"))
