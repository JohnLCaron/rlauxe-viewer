...
public class ContestPoolsTableOld extends JPanel implements ViewerPanelIF {
    static private final Logger logger = LoggerFactory.getLogger(ContestPoolsTableOld.class);
    ...
    public ContestPoolsTableOld(PreferencesExt prefs, TextHistoryPane infoTA, IndependentWindow infoWindow, float fontSize) {
        this.prefs = prefs;
