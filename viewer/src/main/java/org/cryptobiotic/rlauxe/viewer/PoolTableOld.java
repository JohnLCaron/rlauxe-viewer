...
public class PoolTableOld extends JPanel implements ViewerPanelIF {
    ...
    public PoolTableOld(PreferencesExt prefs, TextHistoryPane infoTA, IndependentWindow infoWindow, float fontSize) {
        this.prefs = prefs;
